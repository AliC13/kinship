...
export default function PersonNode({ person, selected, dimmed }) {
  ...
  return (
    <div
      className={`relative bg-white rounded-xl border border-slate-200 shadow-sm transition-all duration-150 ${selected ? 'ring-2 ring-indigo-500 shadow-md' : 'hover:shadow-md hover:border-slate-300'} ${dimmed ? 'opacity-25' : 'opacity-100'}`}
